...
import com.gold.kds517.smartviewmac.adapter.EpisodeListAdapter;
import com.gold.kds517.smartviewmac.adapter.SeasonListAdapter;
import com.gold.kds517.smartviewmac.apps.Constants;
import com.gold.kds517.smartviewmac.apps.MyApp;
import com.gold.kds517.smartviewmac.models.CategoryModelSeries;
...
public class SeriesCatActivity extends AppCompatActivity implements   View.OnClickListener,AdapterView.OnItemClickListener,it.sephiroth.android.library.widget.AdapterView.OnItemClickListener {
                        ...
                        try {
                            ...
                            for(int j = 0;j<e_m.length();j++){
                                try {
                                    ...
                                    movieModel.setNum(String.valueOf(m_m.get("episode_num")));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if(parent == episode_list){
            ...
            MyApp.selectedSeasonModel = seriesFullModels.get(ses_pos);
