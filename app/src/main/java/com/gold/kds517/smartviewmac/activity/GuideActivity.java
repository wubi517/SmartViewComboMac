...
import com.gold.kds517.smartviewmac.adapter.DateListAdapter;
import com.gold.kds517.smartviewmac.adapter.EpgListAdapter;
...
import static com.gold.kds517.smartviewmac.apps.Constants.catchupFormat;
...
public class GuideActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,View.OnClickListener,SimpleGestureListener,
    ...
    private void printEpgData(){
        ...
        if(map.get(date_datas.get(date_pos))!=null){
