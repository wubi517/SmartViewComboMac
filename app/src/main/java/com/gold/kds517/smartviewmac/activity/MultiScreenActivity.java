...
import com.gold.kds517.smartviewmac.dialog.MulteScreenMenuDialog;
import com.gold.kds517.smartviewmac.dialog.SelectChannelDialog;
...
//        if ( mMediaPlayerList.get(i)!=null) mMediaPlayerList.get(i).pause();
        ...
        selectChannelDialog.setSelectChannelListener((category_pos, channel_pos, channelModel) -> {
            ...
            if(MyApp.is_local){
                ...
                JSONObject js;
                String cmd = "ffmpeg http://localhost/ch/"+channelModel.getStream_id()+"_";
                try {
            ...
            contentUriList.set(i, contentUri);
            playVideo(i);
