package com.gold.kds517.smartviewmac;
...
import com.gold.kds517.smartviewmac.activity.LoginActivity;
import com.gold.kds517.smartviewmac.activity.SplashActivity;
import com.gold.kds517.smartviewmac.apps.Constants;
import com.gold.kds517.smartviewmac.apps.FirstServer;
import com.gold.kds517.smartviewmac.apps.MyApp;
import com.gold.kds517.smartviewmac.dialog.UpdateDlg;
...
import static com.gold.kds517.smartviewmac.apps.MyApp.num_server;
...
//        });
    ...
    private void getRespond1(){
        ...
        String data_obj_key = "data_obj"+MyApp.firstServer.getValue();
        try {
            ...
            try {
                ...
                if (object.getBoolean("status")) {
                    ...
                    MyApp.instance.getPreference().put(data_obj_key,data_obj.toString());
                    ...
                    if (url.startsWith("http://") || url.startsWith("https://")) {
                        ...
                        server_editor.putBoolean("safe_mode",false);
                        server_editor.apply();
                    ...
                    Toast.makeText(MainActivity.this, "Expired License or Invalid License!", Toast.LENGTH_SHORT).show();
                }
            ...
            e.printStackTrace();
            if (MyApp.instance.getPreference().containsKey(data_obj_key)){
                try {
                    JSONObject data_obj = new JSONObject((String)MyApp.instance.getPreference().get(data_obj_key));
                    String url = (String) data_obj.get("url");
                    if (url.startsWith("http://") || url.startsWith("https://")) {
                        if (url.endsWith("/")){
                            url = url;
                        ...
                        SharedPreferences.Editor server_editor = serveripdetails.edit();
                        server_editor.putString("ip", url);
                        MyApp.instance.getIptvclient().setUrl(url);
                        version = (String) data_obj.get("version");
                        app_Url = (String) data_obj.get("app_url");
                        String dual_screen = data_obj.getString("pin_2");
                        String tri_screen = data_obj.getString("pin_3");
                        ...
                        server_editor.putString("d1",(String)array.get(3));
                        server_editor.putString("d2",(String )array.get(4));
                        server_editor.putBoolean("safe_mode",true);
                        server_editor.apply();
            ...
            }else Toast.makeText(MainActivity.this, "Invalid Server URL!", Toast.LENGTH_SHORT).show();
        }
    }
