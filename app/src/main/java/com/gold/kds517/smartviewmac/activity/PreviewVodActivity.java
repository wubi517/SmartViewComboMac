...
import com.gold.kds517.smartviewmac.adapter.VodListAdapter;
...
import com.gold.kds517.smartviewmac.dialog.SearchVodDlg;
import com.gold.kds517.smartviewmac.models.CategoryModel;
import com.gold.kds517.smartviewmac.models.MovieInfoModel;
...
//        vod_url = MyApp.instance.getIptvclient().buildMovieStreamURL(MyApp.user,MyApp.pass,mStream_id,type);
        ...
        if(MyApp.is_mac){
            str_cmd = "{\"type\":\"movie\",\"stream_id\":\""+showmodel.getStream_id()+"\",\"stream_source\":null,\"target_container\":\"[\\\""+showmodel.getExtension()+"\\\"]\"}";
            ...
            vod_url = MyApp.instance.getIptvclient().buildMovieStreamURL(MyApp.user,MyApp.pass,showmodel.getStream_id(),showmodel.getExtension());
        }
        Log.e(getClass().getSimpleName(),vod_url);
